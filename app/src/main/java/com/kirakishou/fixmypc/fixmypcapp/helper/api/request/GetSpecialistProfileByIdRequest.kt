 ...
 */
class GetSpecialistProfileByIdRequest(protected val specialistUserId: Long,
    ...
    override fun build(): Single<SpecialistProfileResponse> {
        ...
        return mApiService.getSpecialistProfileById(mAppSettings.loadUserInfo().sessionId, specialistUserId)
    ...
    private fun reLoginAndResendRequest(): Single<SpecialistProfileResponse> {
        ...
        val successObservable = loginResponseObservable
                ...
                .flatMap {
                    return@flatMap mApiService.getSpecialistProfileById(mAppSettings.loadUserInfo().sessionId, specialistUserId)
                            .toObservable()
                }
        ...
        return Observable.merge(successObservable, failObservable)
                .single(SpecialistProfileResponse(SpecialistProfile(), false, ErrorCode.Remote.REC_EMPTY_OBSERVABLE_ERROR))
    }
