...
interface DamageClaimDao {
    ...
    fun findSomeWithinBBox(left: Double, right: Double, bottom: Double, top: Double, page: Long, count: Long): Flowable<List<DamageClaimEntity>>

    @Query("SELECT * FROM ${Constant.Room.TableName.DAMAGE_CLAIM_ENTITY_TABLE_NAME}")
    fun findAll(): List<DamageClaimEntity>
}