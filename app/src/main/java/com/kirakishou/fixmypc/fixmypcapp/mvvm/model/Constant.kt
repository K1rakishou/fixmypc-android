...
object Constant {
    ...
    object ReceiverActions {
        val UPDATE_SPECIALIST_PROFILE_UI_NOTIFICATION = "${APPLICATION_ID}_UPDATE_SPECIALIST_PROFILE_UI"
        val UPDATE_CLIENT_PROFILE_UI_NOTIFICATION = "${APPLICATION_ID}_UPDATE_CLIENT_PROFILE_UI"
        val REFRESH_CLIENT_DAMAGE_CLAIMS_NOTIFICATION = "${APPLICATION_ID}_REFRESH_CLIENT_DAMAGE_CLAIMS"
    }
    ...
    object FragmentTags {
        ...
        val RESPONDED_SPECIALIST_FULL_PROFILE = "${BASE_FRAGMENT_TAG}_RESPONDED_SPECIALIST_FULL_PROFILE"
        val UPDATE_CLIENT_PROFILE = "${BASE_FRAGMENT_TAG}_UPDATE_CLIENT_PROFILE"
    }
