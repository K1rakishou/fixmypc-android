...
object Constant {
    ...
    object ReceiverActions {
        val WAIT_FOR_SPECIALIST_PROFILE_UPDATE_INFO_NOTIFICATION = "${APPLICATION_ID}_SPECIALIST_PROFILE_UPDATE_INFO"
        val WAIT_FOR_SPECIALIST_PROFILE_UPDATE_PHOTO_NOTIFICATION = "${APPLICATION_ID}_SPECIALIST_PROFILE_UPDATE_PHOTO"
    }
