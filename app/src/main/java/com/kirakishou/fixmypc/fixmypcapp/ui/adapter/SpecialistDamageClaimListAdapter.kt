 ...
 */
class SpecialistDamageClaimListAdapter(private val mContext: Context,
    ...
    override fun getBaseAdapterInfo(): MutableList<BaseAdapterInfo> {
        return mutableListOf(
                BaseAdapterInfo(AdapterItemType.VIEW_ITEM, R.layout.adapter_specialist_item_damage_claim,
