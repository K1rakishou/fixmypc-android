...
import com.kirakishou.fixmypc.fixmypcapp.ui.fragment.specialist.SpecialistOptionsFragment
...
class SpecialistMainActivityNavigator(activity: AppCompatActivity) : BaseNavigator(activity) {
    ...
    fun navigateToSpecialistOptions() {
        navigateToFragment(SpecialistOptionsFragment::class,
                Constant.FragmentTags.SPECIALIST_OPTIONS)
    }
}
